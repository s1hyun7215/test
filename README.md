...
| 이름 | GitHub | 주요 작업 |
|------|--------|-----------|
| 전시현<br/>(팀장) | [@s1hyun7215](https://github.com) | 🔹 Redux 기반 전역 상태 아키텍처 설계 및 구현<br/>🔹 React Router를 활용한 SPA 라우터 구성<br/>🔹 Python 백엔드 서버와 AI API 통신 연동<br/>🔹 localStorage 설계 및 영속성 처리 구현<br/>🔹 Home / Favorite / History 페이지 및 핵심 기능 구현<br/>🔹 공통 컴포넌트 및 스타일 구현<br/> |
