...
| 이름 | GitHub | 주요 작업 |
|------|--------|-----------|
| 전시현<br/>(팀장) | [@s1hyun7215](https://github.com) | 🔹 Redux 모듈 설계 및 구현 <br/>🔹 App.jsx 라우터 구성 및 ProtectedRoute 구현 | <br/>🔹 홈 페이지 구현 (증상 입력, Gemini AI 분석 연동) <br/>🔹 결과 페이지 공통 UI 구현 <br/> 🔹 App.jsx 라우터 구성 및 ProtectedRoute 구현 | <br/>🔹 App.jsx 라우터 구성 및 ProtectedRoute 구현 | 
